...
module ReorderChildrenActionSpec
  ...
  describe "Parent#sort_children_action_template#to_html" do
    it "should generate the correct HTML" do
      ...
      <div data-controller="reorder-children-action--template--drag" data-action="dragstart->reorder-children-action--template--drag#dragstart drag->reorder-children-action--template--drag#drag dragover->reorder-children-action--template--drag#dragover dragenter->reorder-children-action--template--drag#dragenter drop->reorder-children-action--template--drag#drop dragend->reorder-children-action--template--drag#dragend">
        <form class="reorder-children-action--template--hidden" action="/a/reorder_children_action_spec/parent/1/sort_children" method="POST">
          <input data-reorder-children-action--template--drag-target="subjectId" type="hidden" name="subject_id">
          <input data-reorder-children-action--template--drag-target="targetId" type="hidden" name="target_id">
          <input data-reorder-children-action--template--drag-target="submit" type="submit" name="submit" value="submit">
        </form>
        <div>
